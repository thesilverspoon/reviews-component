            ...
            <div className='overallrating'>
              <span className='graph'>
                <ul className='bargraph'>
                  5<li class="reddeep"></li>
                  4<li class="redpink"></li>
                  3<li class="pink"></li>
                  2<li class="orangered"></li>
                  1<li class="orange"></li>
                </ul>
              </span>
              ...
              <div className='recommendText'><i class="glyphicon glyphicon-thumbs-up"></i> 96% would recommend it to a friend</div>
